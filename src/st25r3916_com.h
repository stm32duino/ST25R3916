 ...
 * It uses the SPI driver for interfacing with the ST25R3916.
 *
 * API:
 * - Read Register: #st25r3916ReadRegister
 * - Modify Register: #st25r3916ModifyRegister
 * - Write Register: #st25r3916WriteRegister
 * - Write Multiple Registers: #st25r3916WriteMultipleRegisters
 * - Load ST25R3916 FIFO with data: #st25r3916WriteFifo
 * - Read from ST25R3916 FIFO: #st25r3916ReadFifo
 * - Execute direct command: #st25r3916ExecuteCommand
 *
 *
 * \addtogroup RFAL
 * @{
 ...
 * \brief RFAL ST25R3916 Communication
 * @{
 *
 */
